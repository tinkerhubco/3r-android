...
package medina.juanantonio.mlqrscanner.library.ml
...
import medina.juanantonio.mlqrscanner.library.ml.utils.BitmapUtils
import medina.juanantonio.mlqrscanner.library.ml.utils.FrameMetadata
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
    ...
    inner class CameraImageGraphic(
    ...
    inner class ScopedExecutor(private val executor: Executor) : Executor {
